                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @php
                                                        ...
                                                        // jika status tidak ada di map, pakai 'info'
                                                        $badgeColor = $map[$status] ?? 'info';

                                                        // tampilkan label yang rapi (opsional kapitalisasi)
                                                        $label = ucfirst($status);
                                                    @endphp

                                                    <form action="{{ route('Persil.updateStatus', $item->persil_id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        ...
                                                        <div class="dropdown dropup">
                                                            ...
                                                            <ul class="dropdown-menu"
                                                                aria-labelledby="dropdownMenuButton{{ $item->persil_id }}">
                                                                <li><button class="dropdown-item" name="status"
                                                                        value="diterima">Diterima</button></li>
                                                                <li><button class="dropdown-item" name="status"
                                                                        value="pending">Pending</button></li>
                                                                <li><button class="dropdown-item" name="status"
                                                                        value="ditolak">Ditolak</button></li>
                                                            </ul>
                                                        </div>
                                                    </form>
                                                </td>
