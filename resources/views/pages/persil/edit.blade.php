...
@section('content')
@php
    // LOAD DATA LANGSUNG - BYPASS CONTROLLER ISSUE
    $id = request()->segment(2); // ambil ID dari URL: /persil/{id}/edit
    $persil = \App\Models\Persil::find($id);
    $wargas = \App\Models\Warga::all();
    $jenis_penggunaan = \App\Models\jenis_penggunaan::all();

    if (!$persil) {
        abort(404, 'Data persil tidak ditemukan');
    }
@endphp
    ...
    <div class="d-flex align-items-center py-4 mb-4">
        ...
        <div class="flex-grow-1">
            ...
            <p class="mb-0 text-light opacity-75">
                <i class="fas fa-edit me-1"></i> Update land plot information for ID: <strong class="text-danger">{{ $persil->persil_id }}</strong>
            </p>
        </div>
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        ...
        ">
            ...
            <li class="breadcrumb-item active text-light">
                <i class="fas fa-edit me-1"></i> Edit Land Plot
            </li>
        </ol>
    </nav>
                ...
                ">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="mb-1 text-light">Update Land Plot Information</h4>
                                <small class="text-light opacity-75">Edit details for land plot: {{ $persil->kode_persil }}</small>
                            </div>
                        </div>
                    ...
                    <form action="{{ route('persil.update', $persil->persil_id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label text-light mb-2 d-flex align-items-center gap-2" style="font-weight: 500;">
                                        <i class="fas fa-user"></i> Land Owner
                                        <span class="text-danger">*</span>
                                    </label>
                                    <div class="input-group">
                                        <span class="input-group-text" style="
                                        ...
                                        <select class="form-select"
                                            ...
                                            @foreach($wargas as $warga)
                                                <option value="{{ $warga->warga_id }}"
                                                    {{ old('pemilik_warga_id', $persil->pemilik_warga_id) == $warga->warga_id ? 'selected' : '' }}
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-select"
                                                ...
                                                "
                                                required>
                                            <option value="" style="background: #1a1a1a;">-- Select Land Use --</option>
                                            ...
                                            {{-- Jika nilai saat ini tidak ada di list --}}
                                            @if($persil->penggunaan && !$jenis_penggunaan->contains('nama_penggunaan', $persil->penggunaan))
                                                <option value="{{ $persil->penggunaan }}"
                                                        selected
                                                        style="background: #1a1a1a; color: #ff9999;">
                                                    {{ $persil->penggunaan }} (existing data)
                                                </option>
                                            @endif
                                        </select>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control"
                                                  ...
                                                  style="
                                                    ...
                                                    min-height: 100px;
                                                  "
                                                  required>{{ old('alamat_lahan', $persil->alamat_lahan) }}</textarea>
                                    </div>
                                    <small class="text-light opacity-75 mt-2 d-block" style="font-size: 0.8rem;">
                                        <i class="fas fa-info-circle me-1"></i> Character count: <span id="charCount">{{ strlen($persil->alamat_lahan) }}</span>
                                    </small>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-2">
                                            ...
                                            <div class="text-light">
                                                @if($persil->created_at)
                                                    {{ $persil->created_at->format('d M Y, H:i') }}
                                                @else
                                                    N/A
                                                @endif
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-2">
                                            ...
                                            <div class="text-light">
                                                @if($persil->updated_at)
                                                    {{ $persil->updated_at->format('d M Y, H:i') }}
                                                @else
                                                    N/A
                                                @endif
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-2">
                                            ...
                                            <div>
                                                @php
                                                    $status = strtolower($persil->status ?? 'pending');
                    ...
                    <div class="d-flex align-items-start gap-3">
                        ...
                        <div>
                            ...
                            <ul class="text-light opacity-75 mb-0" style="font-size: 0.9rem;">
                                <li>Changing land plot information may affect related documents</li>
                                <li>Verify owner information before updating</li>
                                <li>Ensure area measurements are accurate</li>
...
<script>
    ...
    // Trigger initial color based on current content
