...
class PersilController extends Controller
{
    public function index()
    {
        ...
        return view('admin.form.persil.persil-index', compact('dataPersil'));
    }
    ...
    public function create()
    {
        ...
        $wargaList = Warga::all();
        return view('admin.form.persil.persil-create', compact('wargaList'));
    }
    ...
    public function edit($id)
    {
        ...
        $wargaList = Warga::all();
        return view('admin.form.persil.persil-edit', compact('dataPersil', 'wargaList'));
    }
